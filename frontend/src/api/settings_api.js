...
export async function setValue(name, value) {
    const response = await axios.post(api_path + name, value).catch(e => console.log(e));
    return response.data;
}

export async function removeValue(name) {
    const response = await axios.delete(api_path + name).catch(e => console.log(e));
    return response.data;
}
...
export async function setValueWithFile(name, type, file, payload) {
    ...
    const response = await axios.post(api_path + name, form, {
        headers: {
